...
export function TemplatesGrid() {
  ...
  const handleSelectTemplate = (template: Template) => {
    ...
    const localCV: CVWithRelations = {
      ...
      experiences: [{ id: uid(), position: '', companyName: '', location: '', startDate: null, endDate: null, isCurrent: false, description: '', achievements: [], technologies: [], displayOrder: 0, createdAt: new Date(), updatedAt: new Date(), cvId: '' }],
      education: [{ id: uid(), degree: '', institutionName: '', location: '', startDate: null, endDate: null, isCurrent: false, gpa: '', description: '', achievements: [], displayOrder: 0, createdAt: new Date(), updatedAt: new Date(), cvId: '' }],
      skills: [{ id: uid(), skillName: '', proficiencyLevel: 'intermediate', proficiencyPercentage: 50, category: '', displayOrder: 0, createdAt: new Date(), updatedAt: new Date(), cvId: '' }],
      projects: [{ id: uid(), projectName: '', role: '', startDate: null, endDate: null, isOngoing: false, description: '', achievements: [], technologies: [], projectUrl: '', githubUrl: '', displayOrder: 0, createdAt: new Date(), updatedAt: new Date(), cvId: '' }],
      certifications: [{ id: uid(), name: '', issuingOrganization: '', issueDate: null, expiryDate: null, credentialId: '', credentialUrl: '', description: '', displayOrder: 0, createdAt: new Date(), updatedAt: new Date(), cvId: '' }],
      languages: [{ id: uid(), languageName: '', proficiencyLevel: '3', canRead: true, canWrite: true, canSpeak: true, displayOrder: 0, createdAt: new Date(), updatedAt: new Date(), cvId: '' }],
      awards: [{ id: uid(), title: '', issuer: '', dateReceived: null, description: '', displayOrder: 0, createdAt: new Date(), updatedAt: new Date(), cvId: '' }],
      references: [],
      interests: [],
      activities: [],
    };
