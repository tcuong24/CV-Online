...
export const SECTION_META_CONFIG = {
  ...
  projects:       { label: 'Dự án / Portfolio',         colorBg: '#ede9fe', iconColor: '#7c3aed' },
...
export const DEFAULT_ORDER = ['personalInfo', 'experiences', 'education', 'skills', 'projects', 'awards', 'certifications', 'languages', 'references', 'interests', 'activities'];
